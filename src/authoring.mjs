...
export const CAPABILITIES = {
  ...
  actions: ['click', 'move', 'type', 'key', 'scroll', 'wait', 'waitFor', 'verify', 'selectText', 'drag', 'audioInput'],
  selectors: ['css', 'open-shadow-dom (host >>> target)'],
  microphone: { input: 'local audio files', capture: 'fresh headless Chromium', output: 'opt-in audioClips' },
